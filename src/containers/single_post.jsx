   ...
   */
    ...
    deletePostHandler(self) {
        ...
        swal({
            ...
            FirebaseHandler.deletePost(pid, this.state.post.full_storage_uri, this.state.post.thumb_storage_uri).then(self.onPostDeleteSuccess).catch(error => {
